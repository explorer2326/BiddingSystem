		...
		<div class="row">
			...
			<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
				...
				<div class="widget dashboard-container my-adslist">
                    ...
                    <form enctype='multipart/form-data' method='post' action='addSellingItemsDB.php' name='addNewSellingItem'>
					<table class="table table-responsive product-dashboard-table">
						...
						<tbody>
                            <tr>
                                ...
                                <td><input type='text' name='itemname' size='50'></td>
                            </tr>
                            <tr>
                                <td><label>Category</label></td>
                                <td><select name='category'><option>Clothes</option>
                                                  ...
                                                  <option>Stationery</option></select></td>
                            </tr>
                            <tr>
                                <td><label>Starting Price</label></td>
                                <td><input type='number' name='startingprice' min='0' step='1'></td>
                            </tr>
                            <tr>
                                <td><label>Reserve Price</label></td>
                                <td><input type='number' name='reserveprice' min='0' step='1'></td>
                            </tr>
                            <tr>
                                <td><label>Bidding end date</label></td>
                                <td><input type='date' name='biddingenddate'></td>
                                <td title="Using 'up' and 'down' arrow button to select AM or PM"><input type='time' name='biddingendtime' value='09:00'></td>
                            </tr>
                            <tr>
