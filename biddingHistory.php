				...
				<div class="sidebar">
					...
					<div class="widget user-dashboard-menu">
						<ul>
							...
							<li class="active"><a href="biddingHistory.php"><i class="fa fa-bolt"></i>Bidding History</a></li>
                            ...
                            {   
                                ...
                                while($rowitem=mysqli_fetch_array($data1)){
                                   ...
                                   if($dayleft<0 ||$hourleft<0||$minuteleft<0||$secondleft<0){
                                    if (($biddingprice>$rowitem['currentprice']||$biddingprice=$rowitem['currentprice'])&&$biddingprice>$rowitem['reserveprice']){
                                    echo '<tr>';
                                    ...
                                    echo '<td class="product-details">';
                                        ...
                                        echo '<span><strong>End date: </strong><time>'.$rowitem['biddingenddate'].'</time> </span>';
                               
                                        echo '<span class="location"><strong>Current Price:</strong>'.$rowitem['currentprice'].'</span>';
                                    
                                       
                                         echo '<span class="location"><strong>final bidding:</strong>'.$biddingprice.'</span>';
