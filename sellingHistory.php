				...
				<div class="sidebar">
					...
					<div class="widget user-dashboard-menu">
						<ul>
							...
							<li class="active"><a href="sellingHistory.php"><i class="fa fa-bolt"></i>Selling History</a></li>
				...
				<div class="widget dashboard-container my-adslist">
					...
					<table class="table table-responsive product-dashboard-table">
                        ...
                        if(isLoggedIn())
                        {
                            ...
                            $query="SELECT * FROM selling WHERE userid='{$_SESSION['userid']}'";
                            ...
                            while($row=mysqli_fetch_array($data))
                            {
                                ...
                                echo '<td class="product-details">';
                                    ...
                                    echo '<span><strong>End date: </strong><time>'.$row['biddingenddate'].'</time> </span>';
                               
                                    echo '<span class="location"><strong>Start Price:</strong>'.$row['startingprice'].'</span>';
                                    echo '<span class="location"><strong>Current Price:</strong>'.$row['currentprice'].'</span>';
                                    echo '<span class="location"><strong>Reserve Price:</strong>'.$row['reserveprice'].'</span>';
                                    echo '<span class="location"><strong>Viewing :</strong>'.$row['viewing'].'</span>';
                                    if ($row['currentprice']>=$row['reserveprice']){
                                        $ui = $row['bidderid'];
                                    ...
                                    echo '<span class="location"><strong>State :</strong>successful</span>';
                                    echo '<span class="location"><strong>Final bidder :</strong>'.$rowuser['username'].'</span>';
                                    }
                                     else{
                                         echo '<span class="location"><strong>Viewing :</strong>unsuccessful</span>';
                                     }
                                echo '</td>';
