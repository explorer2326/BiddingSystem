			...
			<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
				...
				<div class="widget dashboard-container my-adslist">
					<h3 class="widget-header">Items</h3>
                      <input class="addnewsell" type='button' name='sellitem' value='Sell New Item' onclick="window.location.href='addSellingItems.php'">
                                ...
                                echo '<td class="action" data-title="Action">';
                                    echo '<div class="">';
                                        echo '<ul class="list-inline justify-content-center">';
                                            ...
                                            echo '</li>';
                                            echo '<li class="list-inline-item">';
                                                echo '<a class="delete" href="'.'http://'.$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']).'/deleteSellingItemsDB.php?itemid='.$row['itemid'].'">';
